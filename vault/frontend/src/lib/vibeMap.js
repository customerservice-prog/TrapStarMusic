...
export const VOCAL_LANE_PRESETS = [
  { mode: 'dark_trap', trackType: 'main', defaultLabel: 'Main lead', strip: 'MAIN', hint: 'Lead — dark trap chain' },
  { mode: 'double', trackType: 'double', defaultLabel: 'Double', strip: 'DBL', hint: 'Tight stack under the lead' },
  { mode: 'adlib', trackType: 'adlib', defaultLabel: 'Adlib', strip: 'ADL', hint: 'Wide accents & tags' },
  { mode: 'harmony', trackType: 'harmony', defaultLabel: 'Harmony', strip: 'HRM', hint: 'Layered melody' },
  { mode: 'midi_lane', trackType: 'midi', defaultLabel: 'MIDI lane', strip: 'MDI', hint: 'Pattern clips — built-in synth preview' },
];
